...
<h1> Nixellar</h1>
<b>Introduction:</b>
<i>Please read about the 'Type of Service' you desire, to know more about it.</i><br>We facilitate 6 services. We have divided them into '3 Types' for user convenience.
<br>
Namely, these are:
<ul>
	<li>from: XLM
		<ul>
		<li> to: Nixellar (Type A)</li>
		<li>to: NIX (Type B)</li>
		</ul>
	</li>
	<li>from: Nixellar
	...
	<li>from: NIX
		<ul>
		<li>to: Nixellar (Type E)</li>
		<li>to: XLM (Type F)</li>
		</ul>
	</li>
</ul>
<h2>Services available on Nixellar:</h2>
<h3>Type A : [XLM] into [Nixellar]</h3>
Users can buy 'Nixellar' on the SDEX using their native 'XLM', for example, from StellarPort.io, StellarX.com, StellarTerm.com etc. directly.
<li>Click <a href="">here</a> for a comprehensive guide.

<h3>Type B : [XLM] into [NIX]</h3>
Firstly, users need to convert their "XLM" to "Nixellar" (asset-code=NIX & issuer= G...i). Then they may proceed to convert this asset into 'NIX'. Please undertake the following steps:<i><ol>
<li>It can be done by partaking "Nixellar Service : Type A" discussed above.
<li>Next, user needs to partake "Nixellar Service : Type D".</ol>
</i>
<li>Click <a href="">here</a> for a comprehensive guide.

<h3>Type C : [Nixellar] into [XLM]</h3>
Users can buy 'XLM' on the SDEX using your 'Nixellar', for example, from StellarPort.io, StellarX.com, StellarTerm.com etc. directly.
<li>Click <a href="">here</a> for a comprehensive guide.

<h3>Type D : [Nixellar] into [NIX]</h3>
Users need to return the 'Nixellar' they hold to the issuing account (address=G...i) on the Stellar blockchain, so that we may remove them from circulation. This is a relatively cheaper process.
<i><ol>
<li>User needs to communicate their "NIX Platform address" to recieve 'NIX'.</li>
<li>User has to send their 'Nixellar' to "Nixellar ('NIX') issuing acount, G...i.</li>
<li>We send the 'NIX' to the users "NIX Platform address".</li>
</ol></i>
<li>Click <a href="">here</a> for a comprehensive guide.
